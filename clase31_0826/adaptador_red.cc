...
void ConsultarEstado(const AdaptadorRed &adaptador)
{
    std::cout << "Adaptador: " << adaptador.nombre<< " | IP: " << adaptador.direccion_ip<< " | Tipo: " << adaptador.tipo_conexion << std::endl;

    std::cout << "Enviado: " << adaptador.stats.enviado<< " KB | Recibido: " << adaptador.stats.recibido << " KB"<< std::endl;
}
